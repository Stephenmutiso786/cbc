...
class Exam extends Model {
    protected $fillable = ['name','exam_group_id','grade_level','class_id','learning_area_id','academic_year','term','exam_type','total_marks','pass_mark','exam_date','start_time','duration_minutes','instructions','status','marks_status','marks_submitted_at','marks_submitted_by','marks_reviewed_at','marks_reviewed_by','marks_review_comment','results_locked_at','locked_by','created_by','results_sms_status','results_sms_queued_at','results_sms_sent_at'];
