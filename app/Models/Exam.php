...
class Exam extends Model {
    protected $fillable = ['name','grade_level','class_id','learning_area_id','academic_year','term','exam_type','total_marks','pass_mark','exam_date','start_time','duration_minutes','instructions','status','results_locked_at','locked_by','created_by'];
    protected $casts = ['exam_date' => 'date', 'results_locked_at' => 'datetime', 'total_marks' => 'decimal:2', 'pass_mark' => 'decimal:2'];
