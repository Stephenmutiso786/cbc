<div class="max-w-3xl mx-auto space-y-6" wire:poll.5s="checkStatus">
    <div>
    ...
    <div class="card p-5 space-y-4">
        ...
        @if ($pendingPaymentId && $pendingStatus === 'pending')
            <div class="rounded-lg border border-yellow-200 bg-yellow-50 p-3 text-sm text-yellow-800">
                STK push sent — enter your M-Pesa PIN on your phone to complete payment. This page updates automatically.
            </div>
