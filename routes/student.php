...
Route::get('/timetable', [StudentPortalController::class, 'timetable'])->middleware('permission:view timetable')->name('timetable');
Route::get('/exam-timetable', [PortalContentController::class, 'studentExamTimetable'])->middleware('permission:view timetable')->name('exam-timetable');
