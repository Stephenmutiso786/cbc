...
Route::get('/fees', fn() => view('parent.fees.index'))->middleware(['permission:view fees', 'feature:fees'])->name('fees.index');
Route::get('/notes', [PortalContentController::class, 'parentNotes'])->middleware(['permission:view notes', 'feature:lesson_plans'])->name('notes.index');
Route::get('/exam-timetable', [PortalContentController::class, 'parentExamTimetable'])->middleware(['permission:view report cards', 'feature:timetable'])->name('exam-timetable');
